...
def hit_paddles():
    global ball_pos_x
    if paddle_1_y <= ball_y <= paddle_1_y + HEIGHT and ball_x <= 10:
        ball_pos_x = -ball_pos_x
    if paddle_2_y <= ball_y <= paddle_2_y + HEIGHT and ball_x >= WIN_WIDTH - 10:
        ball_pos_x = -ball_pos_x
...
def pong():
    ...
    draw_rectangle(0, paddle_1_y, WIDTH, HEIGHT)
    draw_rectangle(WIN_WIDTH - WIDTH, paddle_2_y, WIDTH, HEIGHT)
    draw_ball()
    move_paddles()
    update_ball()
