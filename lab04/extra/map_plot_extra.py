...
from cs1lib import start_graphics, load_image, draw_image, clear, set_stroke_color, draw_line, set_stroke_width, draw_text
...
def main():
    ...
    if current_hover:                               # red highlight for hover     
        ...
        draw_text(current_hover.name, current_hover.xlocation, current_hover.ylocation)   # Draw the vertex name near the vertex
        set_stroke_width(0)       
    ...
    if start_vertex:                                # if start picked, draw it yellow
        ...
        set_stroke_width(2)
        set_stroke_color(0, 0, 0)
        draw_text(start_vertex.name, start_vertex.xlocation, start_vertex.ylocation)   # Draw the vertex name near the vertex
        set_stroke_width(0)
